...
Route::get('/home', 'HomeController@index')->name('home');
    ...
    Route::group(['middleware'=>['web','CheckRole:Administrador']], function(){
        ...
        Route::post('Administrativos/reactive', 'UsersController@reactive')->name('AdminReactive');
    ...
    Route::group(['middleware'=>['web']], function () {
        ...
        Route::post('degrees/disabled', 'DegreesController@disabled')->name('DegreeDisabled')->middleware('checkRole:Administrador');
